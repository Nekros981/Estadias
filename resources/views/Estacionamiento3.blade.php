...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/estacionamiento_03.css">
    <title>Estacionamiento 3 - BIOALIMENTOS</title>
</head>
<body>
    <!-- Encabezado con logo de la UTN y borde negro -->
    <div class="header">
        <img src="{{ asset('imagenes/UTN.png') }}" alt="Logo de la UTN" class="logo-header">
        <p class="texto-encabezado">Estacionamiento 3</p>
        <p class="texto-encabezado">BIOALIMENTOS</p>
    </div>
    ...
    <div class="contenedor-principal">
        ...
        <div class="datos-usuario">
            ...
            <div class="botones-navegacion">
                <button class="btn-nav"><a href="/Estacionamiento1">Estacionamiento 1</a></button>
