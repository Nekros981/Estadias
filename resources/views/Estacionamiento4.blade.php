...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/estacionamiento_04.css">
    <title>Estacionamiento 4 - VINCULACIÓN</title>
</head>
<body>
    <!-- Encabezado con logo de la UTN y borde negro -->
    <div class="header">
        <img src="{{ asset('imagenes/UTN.png') }}" alt="Logo de la UTN" class="logo-header">
        <p class="texto-encabezado">Estacionamiento 4</p>
        <p class="texto-encabezado">VINCULACIÓN</p>
    </div>
